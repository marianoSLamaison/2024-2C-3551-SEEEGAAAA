    ...
    public static class AyudanteSimulacion
    {
        ...
        public struct NarrowPhaseCallbacks : INarrowPhaseCallbacks
        {
            ...
            public void Initialize(Simulation simulation)
            {
                ...
                //Toda logica que se haga suponiendo que ya existe la simulacion, va aqui.
            }
            ...
            {
                /*El sistema tiene una Broad phase que es la parte donde filtra objetos para los cuales a detectado una colision,
                pero todavia no a realizado el analizis a fondo de esta, aqui podemos agregar logica para filtrar objetos
                el ejemplo tiene de base que no detecte colisiones entre dos Kinematicos
                */
            ...
            public bool AllowContactGeneration(int workerIndex, CollidablePair pair, int childIndexA, int childIndexB)
            {
                ...
                /*Probablemente la usemos luego si qeuremos filtrar este tema, en caso de que los autos tengan doble caja*/
                return true;
            }
        ...
        public struct PoseIntegratorCallbacks : IPoseIntegratorCallbacks
        {
            ...
            /// 
            /// El pose integrator, es solamente la parte del programa, encargada de sumar todas las fuerzas
            /// y rotaciones que se han detectado de momento en el objeto y actualizar sus datos con esa informacion
            /// </summary>
            ...
            /// <summary>
            /// Esto deside si los cuerpos kinematicos pueden cambiar su velocidad
            /// 
            ...
            public Vector3 Gravity;//vector de gravedad

            public PoseIntegratorCallbacks(Vector3 gravity) : this()//para setear la gravedad
            {
                Gravity = gravity;
            }
        ...
        public static BodyHandle agregarCuerpoDinamico(RigidPose pose,
                                                ...
                                                float actividad)
        {
            BodyHandle CuerpoAsociado = simulacion.Bodies.Add(
                BodyDescription.CreateDynamic(pose,
                    new BodyInertia { InverseMass = inercia },
                    new CollidableDescription(figura),
                    new BodyActivityDescription(actividad)));
        ...
        public static void SimulacionEjemplo()
        {
            ...
            var sphere = new Sphere(1);//crea una nueva esfera de radio = 1; Estas figuras son singletons, a si que se queda como var
            BodyInertia sphereInertia = sphere.ComputeInertia(1); //calcula la inercia que tendra, suponiendo una masa de 1
            simulation.Bodies.Add(BodyDescription.CreateDynamic(new Vector3(0, 5, 0), sphereInertia, simulation.Shapes.Add(sphere), 0.01f));

            //añade una caja statica
            //la "Pose" es una posicion, pero tambien añade la informacion de la orientacion
